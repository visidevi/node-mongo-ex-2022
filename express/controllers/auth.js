...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  console.log(' req.headers.authorization', token, process.env.JWT_SECRET);
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  if (!user) {
    return next(new AppError('Verify your email address', 404));
  }
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  console.log('req.body.password Funciona!', req.body.password);
